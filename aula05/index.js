...
// uma forma de fazer - obs: mais complexo
...
//outra forma de fazer - código mais limpo
...
function contagemDePets(pets){
    ...
    console.log("temos " + naoVacinados + " pets não vacinados");
} 

// contagemDePets(pets)

//Criar uma função removerPet que ao receber dois parametros (sendo o primeiro o ID do pet, e, o segundo
// a lista na qual queremos um pet). Deveremos reconhecer o pet e excluí-lo, caso o ID passado,
// não seja encontrado na lista de pets, iremos retornar uma mensagem do tipo:
// "Não encontramos nenhum pet com o id"   + idPet
